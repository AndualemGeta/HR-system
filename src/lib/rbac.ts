...
export type PermissionKey =
  ...
  // Phase 5B permissions
  | 'payrollFinalization.view'
  | 'payrollFinalization.create'
  | 'payrollFinalization.review'
  | 'payrollFinalization.approve'
  | 'payrollFinalization.cancel'
  | 'payslip.viewAll'
  | 'payslip.viewOwn'
  | 'payslip.generate'
  | 'payslip.publish'
  ...
  | 'paymentBatch.create'
  | 'paymentBatch.review'
  | 'paymentBatch.approve'
  | 'paymentBatch.release'
  | 'paymentBatch.cancel'
  | 'paymentBatch.export'
  | 'paymentBatch.reconcile'
  | 'statutoryReport.view'
  | 'statutoryReport.generate'
  | 'statutoryReport.review'
  | 'statutoryReport.approve'
  | 'statutoryReport.markFiled'
  | 'statutoryReport.export'
  | 'payrollJournal.view'
  | 'payrollJournal.generate'
  | 'payrollJournal.approve'
  | 'payrollJournal.export'
  | 'paymentExportTemplate.view'
  | 'paymentExportTemplate.manage'
  | 'paymentExportTemplate.approve'
