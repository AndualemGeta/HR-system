...
export default async function EmailTemplatesPage() {
  ...
  return (
    <>
      <header className="page-header"><div className="page-title"><h2>Email Templates</h2><p>Email is disabled unless EMAIL_DELIVERY_ENABLED=true; templates must not expose restricted fields.</p></div><Badge tone="amber">Not enabled for this review</Badge></header>
