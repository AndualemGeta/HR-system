...
export default async function IntegrationTokensPage() {
  ...
  return (
    <>
      <header className="page-header"><div className="page-title"><h2>Integration Tokens</h2><p>Token hashes are stored, raw tokens are shown only once, and external endpoints stay restricted.</p></div></header>
