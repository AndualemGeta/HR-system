...
export default async function PayrollExportTemplatesPage() {
  ...
  return (
    <>
      <header className="page-header"><div className="page-title"><h2>Payroll Export Templates</h2><p>Map approved payroll rows into CSV, XLSX, or JSON layouts without triggering payments.</p></div><Badge tone="amber">No payment processing</Badge></header>
