...
export default async function EmailDeliveryLogsPage() {
  ...
  return (
    <>
      <header className="page-header"><div className="page-title"><h2>Email Delivery Logs</h2><p>Delivery attempts are logged; development delivery is skipped unless explicitly enabled.</p></div><Badge tone="amber">Not enabled for this review</Badge></header>
