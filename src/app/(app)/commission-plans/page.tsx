...
export default async function CommissionPlansPage() {
  ...
  return (
    <>
      <header className="page-header"><div className="page-title"><h2>Commission Plans</h2><p>Effective-dated commission rules for fixed, percent-of-sales, target-based, manual, and deferred tiered plans.</p></div><Badge tone="amber">Complex tiering deferred</Badge></header>
